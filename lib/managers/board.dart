...
class BoardManager extends StateNotifier<Board> {
  ...
  void load() {
    //The box is pre-opened in main() so we can read it synchronously here —
    //state is set before the first paint, no empty-board flash.
    var box = Hive.box<Board>('boardBox');
